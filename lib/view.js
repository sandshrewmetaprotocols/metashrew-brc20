...
exports.Brc20 = exports.Brc20ByAddressResponse = exports.Brc20ByAddressRequest = exports.SatResponse = exports.SatRequest = exports.SatRangesResponse = exports.SatRangesRequest = exports.SatRanges = exports.SatRange = exports.OutPoint = void 0;
...
class OutPoint$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sequence !== 0n)
            writer.tag(3, runtime_1.WireType.Varint).uint64(message.sequence);
...
// @generated message type with reflection information, may provide speed optimized methods
class Brc20ByAddressRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.Brc20ByAddressRequest = new Brc20ByAddressRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Brc20ByAddressResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("ordinals.Brc20ByAddressResponse", [
            { no: 1, name: "outpoints", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.OutPoint },
            { no: 2, name: "brc20s", kind: "message", jsonName: "brc20s", repeat: 1 /*RepeatType.PACKED*/, T: () => exports.Brc20 }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated ordinals.OutPoint outpoints */ 1:
                    message.outpoints.push(exports.OutPoint.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated ordinals.Brc20 brc20s = 2 [json_name = "brc20s"];*/ 2:
                    message.brc20S.push(exports.Brc20.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.outpoints.length; i++)
            exports.OutPoint.internalBinaryWrite(message.outpoints[i], writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* repeated ordinals.Brc20 brc20s = 2 [json_name = "brc20s"]; */
        for (let i = 0; i < message.brc20S.length; i++)
            exports.Brc20.internalBinaryWrite(message.brc20S[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.Brc20ByAddressResponse = new Brc20ByAddressResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Brc20$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tick.length)
            writer.tag(1, runtime_1.WireType.LengthDelimited).bytes(message.tick);
        /* uint64 balance = 2; */
        if (message.balance !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).uint64(message.balance);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
