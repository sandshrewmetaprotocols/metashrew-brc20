namespace __proto {
  ...
  export class SafeDecoder extends Decoder {
...
export namespace brc20 {
  ...
  export class WalletResponse {
    public brc20Balances: Array<Brc20ByAddressResponse> =
      new Array<Brc20ByAddressResponse>();
      ...
      while (!decoder.eof()) {
        ...
        switch (number) {
          case 1: {
            ...
            obj.outpoints.push(
              Brc20ByAddressResponse.decodeDataView(
                new DataView(
                  decoder.view.buffer,
